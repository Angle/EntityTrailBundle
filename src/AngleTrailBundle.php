...
namespace Angle\TrailBundle;

use Doctrine\Bundle\DoctrineBundle\DependencyInjection\Compiler\DoctrineOrmMappingsPass;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\HttpKernel\Bundle\Bundle;

final class AngleTrailBundle extends Bundle
{
    /**
     * The bundle class lives in src/, but config/ and templates/ sit at the
     * package root. Point getPath() there so Symfony registers the `@AngleTrail`
    ...
    public function build(ContainerBuilder $container): void
    {
        ...
        // Register the bundle's own entity (TrailLog) as an attribute-mapped entity
